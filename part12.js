document.addEventListener('DOMContentLoaded', () => {
  ...
  console.log('[Phase 12 Hero Mockup Removal & Centering Initialized]');

  /* 1. Flow State Toggle (Chaos vs Flow Dashboard) - Removed since mockup was deleted */
  ...
  /* 6. Fluid 3D Tilt & Parallax Mouse Interaction (Mockup Frame) - Removed since mockup was deleted */
  ...
  /* ==========================================================================
     8. Unified Cards Spotlight Hover & Tap Interactions
     ========================================================================== */
  const spotlightCards = document.querySelectorAll('.bottleneck-card, .insight-card, .matrix-quadrant');
  spotlightCards.forEach(card => {
    // Mouse movement inside card to update gradient focal point
    ...
    // Touch event listener for mobile device responsive tap states
    ...
    card.addEventListener('touchend', () => {
      ...
      }, 150); // slight delay to make active glow transition readable
    });
